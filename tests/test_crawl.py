...
class TestCrawl:
    ...
    @pytest.mark.asyncio
    async def test_follow_all(self):
    ...
    async def test_timeout_success(self):
        ...
        await crawler.crawl(n=0.5, mockserver=self.mockserver)
    ...
    async def test_timeout_failure(self):
        ...
        crawler = get_crawler(DelaySpider, {"DOWNLOAD_TIMEOUT": 0.35})
        await crawler.crawl(n=0.5, b=1, mockserver=self.mockserver)
        assert crawler.spider.t1 > 0
        assert crawler.spider.t2 == 0
        assert crawler.spider.t2_err > 0
        assert crawler.spider.t2_err > crawler.spider.t1
    ...
    @pytest.mark.asyncio
    async def test_retry_conn_failed(self):
        crawler = get_crawler(SimpleSpider)
        with LogCapture() as log:
            await crawler.crawl(
    ...
    @pytest.mark.asyncio
    async def test_retry_dns_error(self):
    ...
    @pytest.mark.asyncio
    async def test_start_bug_before_yield(self):
        with LogCapture("scrapy", level=logging.ERROR) as log:
            crawler = get_crawler(BrokenStartSpider)
            await crawler.crawl(fail_before_yield=1, mockserver=self.mockserver)
    ...
    @pytest.mark.asyncio
    async def test_start_bug_yielding(self):
        with LogCapture("scrapy", level=logging.ERROR) as log:
            crawler = get_crawler(BrokenStartSpider)
            await crawler.crawl(fail_yielding=1, mockserver=self.mockserver)
    ...
    @pytest.mark.asyncio
    async def test_start_unsupported_output(self):
    ...
    @pytest.mark.asyncio
    async def test_start_dupes(self):
    ...
    @pytest.mark.asyncio
    async def test_unbounded_response(self):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_retry_conn_lost(self):
    ...
    @pytest.mark.asyncio
    async def test_retry_conn_aborted(self):
    ...
    async def test_referer_header(self):
        ...
        await crawler.crawl(seed=req0, mockserver=self.mockserver)
    ...
    @pytest.mark.asyncio
    async def test_format_engine_status(self):
        est = []
    ...
    @pytest.mark.asyncio
    async def test_open_spider_error_on_faulty_pipeline(self):
        settings = {
            "ITEM_PIPELINES": {
    ...
    @pytest.mark.asyncio
    async def test_crawlerrunner_accepts_crawler(self):
        crawler = get_crawler(SimpleSpider)
    ...
    @pytest.mark.asyncio
    async def test_crawl_multiple(self, caplog: pytest.LogCaptureFixture):
...
class TestCrawlSpider:
    ...
    @pytest.mark.asyncio
    async def test_crawlspider_with_parse(self):
    ...
    @pytest.mark.asyncio
    async def test_crawlspider_with_async_callback(self):
    ...
    @pytest.mark.asyncio
    async def test_crawlspider_with_async_generator_callback(self):
    ...
    @pytest.mark.asyncio
    async def test_crawlspider_with_errback(self):
    ...
    @pytest.mark.asyncio
    async def test_crawlspider_process_request_cb_kwargs(self):
    ...
    @pytest.mark.asyncio
    async def test_async_def_parse(self):
    ...
    @pytest.mark.asyncio
    async def test_async_def_asyncio_parse(self):
        crawler = get_crawler(
            AsyncDefAsyncioSpider,
            {
    ...
    @pytest.mark.only_asyncio
    @pytest.mark.asyncio
    async def test_async_def_asyncio_parse_items_single_element(self):
        items = []
    ...
    @pytest.mark.asyncio
    async def test_response_ssl_certificate_none(self):
        crawler = get_crawler(SingleRequestSpider)
    ...
    @pytest.mark.asyncio
    async def test_response_ssl_certificate_empty_response(self):
        crawler = get_crawler(SingleRequestSpider)
    ...
    @pytest.mark.asyncio
    async def test_dns_server_ip_address_none(self):
        crawler = get_crawler(SingleRequestSpider)
    ...
    @pytest.mark.asyncio
    async def test_dns_server_ip_address(self):
        crawler = get_crawler(SingleRequestSpider)
    ...
    @pytest.mark.asyncio
    async def test_bytes_received_stop_download_callback(self):
    ...
    @pytest.mark.asyncio
    async def test_bytes_received_stop_download_errback(self):
    ...
    @pytest.mark.asyncio
    async def test_headers_received_stop_download_callback(self):
    ...
    @pytest.mark.asyncio
    async def test_headers_received_stop_download_errback(self):
    ...
    @pytest.mark.asyncio
    async def test_spider_errback(self):
        failures = []
    ...
    @pytest.mark.asyncio
    async def test_spider_errback_silence(self):
        failures = []
    ...
    @pytest.mark.asyncio
    async def test_spider_errback_exception(self):
        def eb(failure: Failure) -> None:
    ...
    @pytest.mark.asyncio
    async def test_spider_errback_item(self):
    ...
    @pytest.mark.asyncio
    async def test_spider_errback_request(self):
    ...
    @pytest.mark.asyncio
    async def test_spider_errback_downloader_error(self):
        failures = []
    ...
    @pytest.mark.asyncio
    async def test_spider_errback_downloader_error_exception(self):
        def eb(failure: Failure) -> None:
            raise ValueError("foo")
    ...
    @pytest.mark.asyncio
    async def test_spider_errback_downloader_error_item(self):
        def eb(failure: Failure) -> Any:
            return {"foo": "bar"}
    ...
    @pytest.mark.asyncio
    async def test_spider_errback_downloader_error_request(self):
        def eb(failure: Failure) -> Request:
            return Request(self.mockserver.url("/"))
    ...
    @pytest.mark.asyncio
    async def test_raise_closespider(self):
        def cb(response):
            raise CloseSpider

        crawler = get_crawler(SingleRequestSpider)
        with LogCapture() as log:
            await crawler.crawl(seed=self.mockserver.url("/"), callback_func=cb)
        assert "Closing spider (cancelled)" in str(log)
        assert "Spider error processing" not in str(log)

    @pytest.mark.asyncio
    async def test_raise_closespider_reason(self):
        def cb(response):
